...
class RobustOmegaEngine(nn.Module):
    ...
    def step(self, current_val, raw_gradient):
        ...
        if len(self.history) < 5: return current_val, {"mode": "warmup"}
...
if __name__ == "__main__":
    ...
    print(f"{'STEP':<5} | {'STATE':<10} | {'RAW_GRAD':<10} | {'CLEAN_GRAD':<10} | {'STATUS'}")
    print("-" * 70)
